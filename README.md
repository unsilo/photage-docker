...
```bash
mkdir -p ~/photage/import && cd ~/photage
curl -fsSLO https://raw.githubusercontent.com/unsilo/photage-docker/main/docker-compose.yml
curl -fsSLO https://raw.githubusercontent.com/unsilo/photage-docker/main/nginx.conf
curl -fsSL  https://raw.githubusercontent.com/unsilo/photage-docker/main/.env.example -o .env
chmod 600 .env

# fill in PHX_HOST, SECRET_KEY_BASE, POSTGRES_PASSWORD, PHOTAGE_ADMIN_PASSWORD
